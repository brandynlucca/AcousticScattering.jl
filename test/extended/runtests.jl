...
function selected_file(path)
    (EXTENDED_GROUP == "All" || extended_group(path) == EXTENDED_GROUP) &&
...
if EXTENDED_GROUP == "All" || startswith(EXTENDED_GROUP, "modal-")
    selected_file("modal/sphere/general.jl") &&
...
if EXTENDED_GROUP == "All" || startswith(EXTENDED_GROUP, "kirchhoff-")
    selected_file("kirchhoff/sphere/general.jl") &&
        @time @safetestset "Kirchhoff sphere general" include("kirchhoff/sphere/general.jl")
    selected_file("kirchhoff/sphere/layer_reflection.jl") &&
    ...
    selected_file("kirchhoff/cylinder/integral.jl") &&
        @time @safetestset "Kirchhoff cylinder integral" include("kirchhoff/cylinder/integral.jl")
end

if EXTENDED_GROUP == "All" || startswith(EXTENDED_GROUP, "fem-")
    selected_file("fem/sphere/radial.jl") &&
        @time @safetestset "FEM sphere radial" include("fem/sphere/radial.jl")
    selected_file("fem/sphere/meridian.jl") &&
    ...
    selected_file("fem/cylinder/meridian.jl") &&
        @time @safetestset "FEM cylinder meridian" include("fem/cylinder/meridian.jl")
end

if EXTENDED_GROUP == "All" || startswith(EXTENDED_GROUP, "bem-")
    selected_file("bem/sphere/axisymmetric.jl") &&
...
if EXTENDED_GROUP == "All" || startswith(EXTENDED_GROUP, "fourier-")
    selected_file("fourier/sphere.jl") &&
        @time @safetestset "Fourier sphere" include("fourier/sphere.jl")
    selected_file("fourier/spheroid.jl") &&
        @time @safetestset "Fourier spheroid" include("fourier/spheroid.jl")
    selected_file("fourier/irregular.jl") &&
        @time @safetestset "Fourier irregular" include("fourier/irregular.jl")
end
...
if EXTENDED_GROUP == "All" || startswith(EXTENDED_GROUP, "plot-")
    selected_file("plot/plot1d.jl") &&
        @time @safetestset "Plot 1D" include("plot/plot1d.jl")
    selected_file("plot/plot2d.jl") &&
        @time @safetestset "Plot 2D" include("plot/plot2d.jl")
    selected_file("plot/plot3d.jl") &&
        @time @safetestset "Plot 3D" include("plot/plot3d.jl")
end
