...
@time "Low-frequency fluid regions" @testset "Low-frequency fluid regions" begin
    k = 2pi * 500 / 1477.4
    ...
    @time "Nested ellipsoid: $formulation" @testset "Nested ellipsoid: $formulation" for formulation in (:muller,)
