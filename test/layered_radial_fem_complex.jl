...
@testset "Solid sphere complex rigid and shrinking-cavity limits" begin
    body = Sphere(1.0)
...
@testset "Elastic radial refinement and interior coupling" begin
    body = Sphere(1.0)
...
@testset "Elastic and layered radial FEM frequency sweeps" begin
    body = Sphere(0.01)
