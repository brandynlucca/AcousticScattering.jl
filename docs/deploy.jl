...
function deployment_allowed(environment)
    ...
    return get(environment, "GITHUB_ACTIONS", "false") == "true" && event == "push" &&
...
if abspath(PROGRAM_FILE) == @__FILE__
    deployment_allowed(ENV) ||
        throw(ArgumentError("Documentation deployment requires a main or release-tag push in the upstream GitHub repository"))
